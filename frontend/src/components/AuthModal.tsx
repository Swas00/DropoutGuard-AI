...
export const AuthModal: React.FC<AuthModalProps> = ({ isOpen, onClose, initialMode = 'login' }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal Container */}
      <div className={`relative w-full ${mode === 'register' ? 'max-w-2xl' : 'max-w-lg'} bento-box bg-[#070b14]/95 p-6 sm:p-8 space-y-5 z-10 border border-white/[0.12] shadow-2xl max-h-[90vh] overflow-y-auto animate-in fade-in zoom-in-95 duration-200 transition-all`}>
        ...
        <div className="flex items-center justify-between border-b border-white/[0.08] pb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 font-mono">Apex University • Office of Student Retention</p>
            </div>
          </div>
          <button 
            onClick={onClose}
        ...
        <div className="p-3.5 rounded-2xl bg-black/50 border border-indigo-500/25 space-y-2">
          <div className="flex items-center justify-between">
            ...
            <span className="text-[10px] font-mono text-slate-500">Instant Access</span>
          </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-2.5">
                  ...
                  >
                    ...
                    <span className="text-[9px] text-slate-500 font-mono">Full Executive Suite</span>
                  </button>
