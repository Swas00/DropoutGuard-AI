...
export const LanguageSwitcher: React.FC = () => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-56 sm:w-64 max-w-[calc(100vw-1.5rem)] rounded-2xl bg-[#070b14]/98 backdrop-blur-3xl border border-white/[0.12] shadow-2xl p-2 z-50 animate-in fade-in slide-in-from-top-2 duration-150">
          
          <div className="px-2.5 py-2 border-b border-white/[0.06] mb-1 flex items-center justify-between">
            ...
            <span className="text-[9px] font-mono text-slate-500">6 Indian & Global</span>
          </div>
