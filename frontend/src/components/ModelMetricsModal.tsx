...
export const ModelMetricsModal: React.FC<Props> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-md p-4">
      <div className="bento-box bg-[#070b14]/95 max-w-2xl w-full p-6 sm:p-8 space-y-6 shadow-2xl overflow-y-auto max-h-[90vh] border border-white/[0.12] animate-in fade-in zoom-in-95 duration-200">
        <div className="flex items-center justify-between border-b border-white/[0.08] pb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 font-mono">Trained on {recordCount.toLocaleString()} verified institutional records (UCI Repository)</p>
            </div>
          </div>
          <button 
            onClick={onClose}
        ...
        <div className="p-3.5 rounded-xl bg-black/50 border border-white/[0.08] text-xs text-slate-300 flex items-start gap-2.5">
          ...
          <div className="overflow-x-auto rounded-xl border border-white/[0.08] bg-black/40">
            <table className="w-full text-left text-xs font-mono">
              ...
              <tbody className="divide-y divide-white/[0.04]">
                <tr className="text-slate-200 bg-indigo-500/[0.06]">
                ...
                <tr className="text-slate-400">
                  <td className="py-2.5 px-3 font-semibold">Logistic Regression</td>
